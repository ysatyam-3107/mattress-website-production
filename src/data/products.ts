...
export const blogPosts = [
  {
    ...
    excerpt: "Your sleep position plays a crucial role in determining the best mattress for you. Here's a comprehensive guide to finding your perfect match.",
  ...
  },
  {
    ...
    excerpt: "Suffering from back pain? The right mattress can make all the difference. Learn what to look for and our top recommendations.",
    category: "Health",
    readTime: "7 min read",
    date: "March 10, 2026",
  },
  {
    ...
    excerpt: "From sleep hygiene to room temperature, discover proven strategies to get deeper, more restful sleep every night.",
    category: "Sleep Tips",
    readTime: "6 min read",
    date: "March 5, 2026",
  },
  {
    ...
    excerpt: "Understanding the differences between mattress types can help you make an informed decision. We break it all down.",
    category: "Comparison",
    readTime: "8 min read",
