...
const SmartMattressFinder = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-2xl mx-auto border border-primary/10">
        ...
        {step < 3 ? (
          ...
          <div className="text-center space-y-6 animate-fade-in">
            ...
            <div className="bg-secondary/10 p-6 rounded-xl border border-secondary/20">
              ...
              <h5 className="text-3xl font-extrabold text-primary mb-2">CloudRest Hybrid Pro</h5>
              <p className="text-sm text-foreground/80 mb-4">Combines adaptive pocket springs with pressure-relieving gel foam.</p>
