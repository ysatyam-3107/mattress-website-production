  ...
  <div className="py-16">
    <div className="container space-y-8">
      <div className="flex flex-col items-center gap-3">
        <div className="h-4 w-24 bg-gray-100 dark:bg-muted rounded-lg shimmer" />
        <div className="h-8 w-64 bg-gray-100 dark:bg-muted rounded-lg shimmer" />
        <div className="h-4 w-48 bg-gray-100 dark:bg-muted rounded-lg shimmer" />
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {[1,2,3,4].map(i => (
          <div key={i} className="space-y-3">
            <div className="aspect-square bg-gray-100 dark:bg-muted rounded-2xl shimmer" style={{ animationDelay: `${i * 0.1}s` }} />
            <div className="h-4 bg-gray-100 dark:bg-muted rounded-lg w-3/4 shimmer" />
          </div>
        ))}
      </div>
    </div>
        ...
        <div className="container relative z-10">
          <div className="mb-10 text-center max-w-3xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-5">
              <div className="h-px w-10 bg-gold-light/50" />
              <span className="text-gold-light font-bold text-[11px] tracking-[0.2em] uppercase font-montserrat">
                Sleep Quiz
              </span>
              <div className="h-px w-10 bg-gold-light/50" />
            </div>
            <h2 className="text-3xl lg:text-5xl font-playfair text-white mb-4 font-bold leading-tight">
              Not sure what <span className="text-gradient">to choose?</span>
            </h2>
      ...
      <section className="py-16 bg-[#111827] relative overflow-hidden">
        ...
        <div className="container max-w-4xl relative z-10">
          <div className="text-center mb-10">
            <div className="flex items-center justify-center gap-2 mb-5">
              <div className="h-px w-10 bg-gold-light/30" />
              <span className="text-gold-light font-bold text-[11px] tracking-[0.2em] uppercase font-montserrat">
                Compare
              </span>
              <div className="h-px w-10 bg-gold-light/30" />
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 text-white font-playfair">The Smart Choice is Clear</h2>
      ...
      <section className="py-16 relative overflow-hidden bg-gradient-to-br from-[#0f1d47] to-[#1E3A8A]">
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h2 className="text-3xl lg:text-5xl font-playfair text-white mb-4 font-bold leading-tight">
              Check Your <span className="text-gradient">Sleep Health</span>
            </h2>
            <p className="text-blue-200/80 text-lg md:text-xl font-light tracking-wide leading-relaxed font-montserrat">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 auto-rows-[1fr]">
            ...
            <Link
              ...
              className="lg:col-span-7 group relative rounded-3xl overflow-hidden min-h-[480px] flex flex-col justify-end shadow-premium hover:shadow-premium-lg transition-all duration-500"
            >
              <img
                src={heroImg}
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-5">
              ...
              <Link
                ...
                className="group relative rounded-3xl overflow-hidden flex flex-col justify-end shadow-premium hover:shadow-premium-lg transition-all duration-300"
              >
                <img
                  src={orthopedicImg}
                  alt="Back pain guide"
